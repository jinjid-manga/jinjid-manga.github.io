<template>
    ...
    >
        ...
        <div
            v-if="manga"
            class="absolute inset-0 flex items-center justify-between p-4 pointer-events-none transition-opacity duration-200"
        ...
        <div
            v-if="manga"
            class="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-black/50 text-white px-4 py-2 rounded-full pointer-events-none transition-opacity duration-200"
            :class="{ 'opacity-0': !showControls, 'opacity-100': showControls }"
        >
